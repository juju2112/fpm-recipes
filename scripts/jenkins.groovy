pipeline
{
   ...
   parameters
   {
     ...
     gitParameter branchFilter: 'origin/(.*)', defaultValue: 'master', selectedValue: 'DEFAULT', name: 'BRANCH', type: 'PT_BRANCH', sortMode: 'DESCENDING_SMART', description: 'The branch of fpm-recipes that should be checked out (3.2, 3.3, master, etc).'
   }
